export const ATTENDANCE_CODE_CATALOG = [
  ['L', 'LICENCIA'], ['PP', 'PERMISO PERSONAL'], ['PO', 'PERMISO OFICIAL'],
  ['CM', 'MEDICO IHSS'], ['MP', 'MEDICO PRIVADO'], ['SSP', 'SERVICIO DE SALUD PUBLICA'],
  ['OP', 'OTROS PASES'], ['PS', 'PERMISO DE SALUD'], ['I', 'INCAPACIDAD'], ['LT', 'LLEGADA TARDIA'],
