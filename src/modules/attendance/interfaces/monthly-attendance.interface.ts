export const ATTENDANCE_CODE_CATALOG = [
  ...
  ['CM', 'MEDICO IHSS'],
  ['MP', 'MEDICO PRIVADO'],
  ['SSP', 'SERVICIO DE SALUD PUBLICA'],
  ['OP', 'OTROS PASES'],
  ['PS', 'PERMISO DE SALUD'],
  ['I', 'INCAPACIDAD'],
  ['LT', 'LLEGADA TARDIA'],
  ['PTE', 'TERAPIA'],
  ['D', 'DEDUCCION DIA COMPLETO'],
  ['DC', 'DIA COMPENSATORIO'],
  ['V', 'VACACION'],
  ['VP', 'VACACION PROFILACTICA'],
  ['ACV', 'ASUETO A CUENTA DE VACACIONES'],
  ['F', 'SOLO PARA ASUETOS'],
  ['LR/D', 'LICENCIA REMUNERADA DE DUELO'],
  ['LR/N', 'LICENCIA REMUNERADA POR NUPCIAS'],
  ['LR/CAL', 'LICENCIA REMUNERADA CALAMIDAD'],
  ['LR/CUI', 'LICENCIA REMUNERADA POR CUIDADOS'],
  ['LNR', 'LICENCIA NO REMUNERADA'],
  ['PE', 'PERMISO DE ESTUDIO'],
  ['PRN', 'PRENATAL'],
  ['PSNT', 'POSTNATAL'],
] as const;
...
export interface MonthlyAttendanceReport {
  ...
  employees: Array<{
    ...
    days: Record<number, AttendanceDayResult>;
    observations: string;
  }>;
  warnings: string[];
}
...
export interface BiometricMark {
  entry: string | null;
  exit: string | null;
}
